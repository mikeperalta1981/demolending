...
<div style="margin: 0 auto; text-align: center"><h3>CUSTOMERS FOR COLLECTION FORM</h3></div>

<table class="detail" style="margin: 0px; border-top: none;">

<tr>
<td class="label">Area:</td>
<td class="field"><?php echo $area_name;?></td>
<td class="label">Date of Transaction:</td>
<td class="field"><?php echo date('Y-m-d')?></td>
</tr>

<tr>
<td class="label">Name of FC:</td>
<td class="field"><?php echo $collector_name?></td>
</tr>
</table>
...
<tr class="head">
<td class="center" style="width: 15%">Account number</td>
<td class="left" style="width: 35%">Name of Customer</td>
<td class="right" style="width: 15%">Daily Amort</td>
<td class="right" style="width: 15%">Amount paid</td>
...
<?php foreach($data as $val):?>
	<tr class="list_row">
		<td class="center"><?php echo $val['account_no']?></td>
		<td class="left"><?php echo $val['name']?></td>
		<td class="right"><?php echo number_format($val['amortization'], 2, '.', ',')?></td>
		<td class="right"></td>
		<td class="center"></td>
	</tr>
...
<td class="right" style="font-weight: bold">PHP <?php //echo number_format($total_payments, 2, '.', ',')?></td>
</tr>
 -->
...
<table class="signature_table">
  ...
  <tr>    
    <td>Number of Accounts: <strong><?php echo count($data);?></strong></td>
    <td>&nbsp;</td>
    <td style="padding-left: 1em">Total Collection:</td>
    <td id="total_collection" style="width: 39%; text-align: right;"></td>
  </tr>
  <tr>
  	<td class="written_field" style="width: 38%; padding-top: 5em;">&nbsp;</td>
