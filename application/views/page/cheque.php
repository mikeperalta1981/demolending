...
<div style="margin: 0 auto; text-align: center; font-size: 12px;"><strong></strong></div>

<br>



<table class="detail" style="margin: 0px; border: none; width:100%; padding-top: 4px; font-size: 12px" width="100%">

<tr>
	<td style="font-size: 10px"><strong></strong></td>
	<td style="float: right; margin: 0">
		<span style='padding-left: 595px; font-size: 13px; font-family: Calibri, Candara, Segoe, "Segoe UI", Optima, Arial, sans-serif; font-weight: bold'><?php echo $date?></span> 
	</td>
</tr>
</table>

<table class="detail" style="margin: 0px; border: none; width:100%; padding-top: 10px; font-size: 13px" width="100%">
<tr>
	<td style="float: left; margin: 0">
		<span style='margin-left: 120px; font-size: 12px; font-weight: bold; width: 300px; font-family: Calibri, Candara, Segoe, "Segoe UI", Optima, Arial, sans-serif;'><?php echo $name?></span>
	</td>
	<td style="padding-right: 100px; float: right">
		<span style='margin-left: 170px; font-size: 13px; font-weight: bold; font-family: Calibri, Candara, Segoe, "Segoe UI", Optima, Arial, sans-serif;'>***<?php echo number_format($net)?>***</span> 
	</td>
</tr>
<tr>
  <td colspan="2" style="padding-top: 7px;">
    <span style='margin-left: 120px; font-size: 12px; font-weight: bold; font-family: Calibri, Candara, Segoe, "Segoe UI", Optima, Arial, sans-serif;'><?php echo strtoupper($net_in_words)?> PESOS ONLY</span>
  </td>
</tr>
</table>
