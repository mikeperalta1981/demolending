...
<tr>
	<td style="word-wrap:break-word;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<span style="display:inline-block;  text-align: center;width: 140px;"><strong class="pntr_data"><?php echo $contract_address?></strong></span> 
		<span class="pntr_form">this</span> 
		<span style="display:inline-block;  text-align: center;width: 20px; "><strong class="pntr_data"><?php echo date('d', strtotime($date))?></strong></span> 
		<span class="pntr_form">day <br>of</span> 
		<span style="display:inline-block;  text-align: center;width: 30px; "><strong class="pntr_data"><?php echo date('M', strtotime($date))?></strong></span>
		<span class="pntr_form">20</span> 
		<span style="display:inline-block;  text-align: center;width: 30px; "><strong class="pntr_data"><?php echo substr(date('Y', strtotime($date)), -2)?></strong></span> 
...
<tr>	
	<td style="word-wrap:break-word;" >
		<span class="pntr_form">the</span> 
	 	<span style="display:inline-block;  text-align: center;width: 350px; "><strong class="pntr_data"><?php echo $business_name?></strong></span>
	 	...
	 	<span style="display:inline-block;  text-align: center;width: 360px; "><strong class="pntr_data"><?php echo $business_address?></strong></span>
	 	<br>
	 	<span class="pntr_form">represented herein by</span> 
	 	<span style="display:inline-block;  text-align: center;width: 300px; "><strong class="pntr_data"><?php echo $first_party?></strong></span> 
...
<tr>
	<td style="padding-left: 300px"><span class="pntr_form">&nbsp;</span></td>
</tr>
<tr>	
	<td style="word-wrap:break-word;">
		<span style="display:inline-block;  text-align: center;width: 400px; "><strong class="pntr_data"><?php echo $data['name']?></strong></span>
		<span class="pntr_form">Filipino, of legal age,</span> 
		<span style="display:inline-block;  text-align: center;width: 140px; "><strong class="pntr_data"><?php echo $data['marital_status']?></strong></span>
		<br>
		<span class="pntr_form">and residing at</span> 
		<span style="display:inline-block;  text-align: center;width: 570px; "><strong class="pntr_data"><?php echo $data['address']?></strong></span>
		<br> 
		<span class="pntr_form">and</span>
		<span style="display:inline-block;  text-align: center;width: 400px; "><strong class="pntr_data"><?php echo $data['useSpouse']==1 ?  $data['spouse_name'] : '&nbsp;' ?></strong></span>
		<span class="pntr_form">, Filipino, of legal age, single/married and residing</span>
		<br>
		<span class="pntr_form">at</span> <span style="display:inline-block;  text-align: center;width: 350px; "><strong class="pntr_data"><?php echo $data['useSpouse']==1 ? $data['address'] : '&nbsp;' ?></strong></span>
...
<tr>
	...
	<span style="display:inline-block;  text-align: center;width: 280px; "><strong class="pntr_data"><?php echo strtoupper($la_in_words)?> PESOS ONLY</strong></span>
	<br>
	<span class="pntr_form">(P</span>
	<span style="display:inline-block;  text-align: center;width: 100px; "><strong class="pntr_data"><?php echo number_format($data['loan_amount'], 2)?>)</strong></span>
	 <span class="pntr_form">with interest at the rate of</span>
	 <span style="display:inline-block;  text-align: center;width: 50px; "><strong class="pntr_data"><?php echo $data['interest_pct']?></strong></span>
...
<tr>
	<td>
		...
		<span style="display:inline-block;  text-align: center;width: 100px; "><strong class="pntr_data">P <?php echo number_format($data['service_fee_amount'], 2)?></strong></span>
...
<tr>
	...
	<span style="display:inline-block;  text-align: center;width: 70px; "><strong class="pntr_data">P <?php echo number_format($data['loan_proceeds'], 2)?></strong></span>
	<span class="pntr_form">after deducting the</span> 
	<span style="display:inline-block;  text-align: center;width: 30px; "><strong class="pntr_data"><?php echo $data['interest_pct']?></strong></span>
	<span class="pntr_form">%</span>
	<br>
...
<tr>
	...
	<br> 
	<span style="display:inline-block;  text-align: center;width: 300px; "><strong class="pntr_data"><?php echo strtoupper($amort_in_words)?> PESOS ONLY</strong></span> 
	<span style="display:inline-block;  text-align: center;width: 70px; "><strong class="pntr_data">(P <?php echo number_format($data['amortization'], 2)?>)</strong></span>
	<span class="pntr_form">;</span>
	</td>
</tr>
<tr>
	...
	<span style="display:inline-block;  text-align: center;width: 100px; "><strong class="pntr_data"><?php echo $payment_start; ?></strong></span>
	<span class="pntr_form">which shall be paid at the FIRST PARTY'S office located</span> 
	<br>
	<span class="pntr_form">at</span>
	<span style="display:inline-block;  text-align: center;width: 300px; "><strong class="pntr_data"><?php echo $business_address; ?></strong></span>
...
<tr>
	...
	<span style="display:inline-block;  text-align: center;width: 330px; "><strong class="pntr_data"><?php echo $data['co_maker1'] != '' ? $data['co_maker1'] : '&nbsp;' ?></strong></span>
	<span class="pntr_form">, Filipino, single/married, of legal age, and a resident </span><br>
	<span class="pntr_form">of </span>
	<span style="display:inline-block;  text-align: center;width: 300px; "><strong class="pntr_data"><?php echo $data['co_maker1_address'] != '' ? $data['co_maker1_address'] : '&nbsp;'?></strong></span>
	<span class="pntr_form">and Mr./Mrs./Ms. </span>
	<span style="display:inline-block;  text-align: center;width: 250px; "><strong class="pntr_data"><?php echo $data['co_maker2'] != '' ? $data['co_maker2'] : '&nbsp;'?></strong></span>
	<br>
...
<tr>
	...
	<span style="display:inline-block;  text-align: center;width: 300px; "><strong class="pntr_data"><?php echo $data['co_maker1'] != '' ? $data['co_maker1'] : '&nbsp;' ?></strong></span>
...
<tr>
	...
	<span style="display:inline-block;  text-align: center;width: 200px; "><strong class="pntr_data"><?php echo $data['loan_purpose']?></strong></span>
	<span class="pntr_form">,</span>
	</td>
</tr>
<tr>
	...
	<br>
	<span style="display:inline-block;  text-align: center;width: 200px; "><strong class="pntr_data"><?php echo $data['type_of_business']?></strong></span>
...
<tr>
	...
	<br>
	<span class="pntr_form"> at</span>
	<span style="display:inline-block;  text-align: center;width: 200px; "><strong class="pntr_data"><?php echo $data['address'] != '' ? $data['address'] : '&nbsp;' ?></strong></span>
...
<tr>
	...
	<span style="display:inline-block;  text-align: center;width: 100px; "><strong class="pntr_data"><?php echo date('M d, Y', strtotime($data['date_released']))?></strong></span> 
	<span class="pntr_form">at</span>
	<span style="display:inline-block;  text-align: center;width: 200px; "><strong class="pntr_data">Camalig, Albay.</strong></span>
	</td>
</tr>
</table>
...
<table style="border: none; width: 90%;" align="center">
  	<tr>
		<td>
		<span style="display:inline-block;  width: 200px; "><strong class="pntr_data"><?php echo $data['co_maker1'] != '' ? $data['co_maker1'] : '&nbsp;' ?></strong></span>
		<br>
		<span style="font-size: 8px" class="pntr_form">&nbsp;&nbsp;CO-MAKER</span>
		</td>
		<td style="width: 40%"></td>
		<td>
		<span style="display:inline-block;  width: 200px; "><strong class="pntr_data"><?php echo $data['name'] != '' ? $data['name'] : '&nbsp;' ?></strong></span>
		<br>
	...
	<tr>
		<td>
		<span style="display:inline-block;  width: 200px; "><strong class="pntr_data"><?php echo $data['co_maker2'] != '' ? $data['co_maker2'] : '&nbsp;' ?></strong></span>
		<br>
		<span style="font-size: 8px" class="pntr_form">&nbsp;&nbsp;CO-MAKER</span></td>
		<td>&nbsp;</td>
		<td>
		<span style="display:inline-block;  width: 200px; "><strong class="pntr_data"><?php echo $data['useSpouse']==1 ? ($data['spouse_name'] != '' ? $data['spouse_name'] : '&nbsp;') : '&nbsp;' ?></strong></span>
		<br>
...
<table style="border: none; width: 100%;" align="center">
  	<tr>
		<td style="width: 40%"></td>
		<td>
		<span style="display:inline-block;  width: 200px; "><strong class="pntr_data"><?php echo $first_party ?></strong></span>
		<br>
...
<table style="border: none; width: 90%;" align="center">
  	<tr>
		<td>
		<span style="display:inline-block;  width: 200px; "><strong class="pntr_data"><?php echo $data['witness1'] != '' ? $data['witness1'] : '&nbsp;' ?></strong></span>
		<br>
		<span style="font-size: 8px" class="pntr_form">&nbsp;&nbsp;WITNESS</span></td>
		<td style="width: 40%"></td>
		<td>
		<span style="display:inline-block;  width: 200px; "><strong class="pntr_data"><?php echo $data['witness2'] != '' ? $data['witness2'] : '&nbsp;' ?></strong></span>
		<br>
		<span style="font-size: 8px" class="pntr_form">&nbsp;&nbsp;WITNESS</span></td>
...
<table style="border: none; width: 100%; margin-top: -15px; padding-left: 10px; padding-right: 10px" align="center">
	...
	<tr>
		...
		<td>
		<span style="display:inline-block;  width: 200px; "><strong class="pntr_data"><?php echo $data['maker_id'] != '' ? $data['maker_id'] : '&nbsp;' ?></strong></span>
		</td>
		<td><span style="display:inline-block;  width: 200px; "><strong class="pntr_data"><?php echo $data['maker_id_issue_date'] != '' ? $data['maker_id_issue_date'] : '&nbsp;' ?></strong></span>
		</td>
	</tr>
	<tr>
		<td>
		...
		<td>
		<span style="display:inline-block;  width: 200px; "><strong class="pntr_data"><?php echo $data['co_maker1_id'] != '' ? $data['co_maker1_id'] : '&nbsp;' ?></strong></span>
		</td>
		<td>
		<span style="display:inline-block;  width: 200px; "><strong class="pntr_data"><?php echo $data['co_maker1_id_issue_date'] != '' ? $data['co_maker1_id_issue_date'] : '&nbsp;' ?></strong></span>
		</td>
	</tr>
	<tr>
		<td>
		<span style="display:inline-block;  width: 200px; "><strong class="pntr_data"><?php echo $first_party != '' ? $first_party : '&nbsp;' ?></strong></span>
		</td>
		<td>
		<span style="display:inline-block;  width: 200px; "><strong class="pntr_data"><?php echo $first_party_id != '' ? $first_party_id : '&nbsp;' ?></strong></span>
		</td>
		<td>
		<span style="display:inline-block;  width: 200px; "><strong class="pntr_data"><?php echo $first_party_id_issue_date != '' ? $first_party_id_issue_date : '&nbsp;' ?></strong></span>
		</td>
	</tr>
	...
	<tr>
		<td>
			<span style="display:inline-block;  width: 200px; "><strong class="pntr_data"><?php echo $data['spouse_name'] != '' ? $data['spouse_name'] : '&nbsp;' ?></strong></span>
		</td>
		<td>
			<span style="display:inline-block;  width: 200px; "><strong class="pntr_data"><?php echo $data['co_borrower_id'] != '' ? $data['co_borrower_id'] : '&nbsp;' ?></strong></span>
		</td>
		<td>
			<span style="display:inline-block;  width: 200px; "><strong class="pntr_data"><?php echo $data['co_borrower_id_issue_date'] != '' ? $data['co_borrower_id_issue_date'] : '&nbsp;' ?></strong></span>
		</td>
	</tr>
	<?php endif;?>
