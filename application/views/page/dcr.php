...
<div style="margin: 0 auto; text-align: center"><h3>DAILY COLLECTION RECORD</h3></div>
<div style="margin: 0 auto; text-align: center;"  class="fordotmatrix">Transaction date: <?php echo date('M d, Y', strtotime($date))?></div>
<br>

<?php $count_area = count($data); $i=1;?>
<?php foreach($data as $key => $val):?>

<table class="detail" style="margin: 0px; width: 70%;; border: 0px;">

<tr>
<td class="label"><span class="fordotmatrix">Area: <strong><?php echo $key;?></strong></span></td>
<td class="label"><span class="fordotmatrix">FC NAME: <strong><?php echo $collector_name;?></strong></span></td>
...
<table class="list" style="width: 70%;  page-break-after:always; border: 0px; text-align: center" align="center">

<tr class="head">
<td class=""><span class="fordotmatrix">Account No.</span></td>
<td class=""><span class="fordotmatrix"">Name of Customer</span></td>
<!-- <td class="right" style="width: 15%">Daily Amort</td> -->
<td class=""><span class="fordotmatrix">Amount paid</span></td>
<td class=""><span class="fordotmatrix">Type of collection</span></td>
<!-- <td class="center" colspan="2" style="width: 15%">Unit Cost</td>
<td class="center" style="width: 20%">Conforme (Sign of Customer)</td> -->
</tr>

<?php ksort($val); foreach($val as $v):?>
	<tr class="list_row">
		<td class="" style="width: 50px;"><?php echo $v['account_no']?></td>
		<td class="" style="width: 200px; text-align: left"><?php echo $v['name']?></td>
		<td class=""  style="width: 100px; text-align: right"><?php echo number_format($v['amount'], 2, '.', ',')?></td>
		<td class=""  style="width: 100px; text-align: right"><?php echo $v['type_of_collection']?></td>
	</tr>
...
<strong><span class="dcr_total">TOTAL:</span></strong></td>
<td class="right"><span class="dcr_total">PHP <?php echo number_format($total_per_area[$key], 2, '.', ',')?></span></td>
<td></td>
</tr>
 <tr>
 	<td>
 		<table style="margin-top: 20px">
 			<tr>
	 			<td style="text-align: left; width: 300px" class="fordotmatrix">
	              SIGNATURE OVER PRINTED NAME OF FC</td>
    		</tr>
    		<tr>
    			<td style="padding-top: 20px">__________________________________</td>
    		</tr>
 		</table>
 	</td>
  ...
  <tr>
  	<td>
  		<table  style="width: 99%; margin-top: 30px">
  		  <tr>
		    <td style="text-align: left;" class="fordotmatrix">
		              In Collection: <strong>P <?php echo number_format($total_in_collection)?></strong></td>
		    <td style="padding-top: 0em"></td>
		  </tr>
		  <tr>
		    <td style="text-align: left;"  class="fordotmatrix">
		              Out Collection: <strong>P <?php echo number_format($total_out_collection)?></strong></td>
		    <td style="padding-top: 0em"></td>
		  </tr>
		  <tr>
		    <td style="text-align: left;"  class="fordotmatrix">
		              Grand Total: <strong>P <?php echo number_format($grand_total)?></strong></td>
		    <td style="padding-top: 0em"></td>
		  </tr>
		</table>
  	</td>
  ...
  <tr>
  	<td colspan="3" style="border: none">
  		<table  style="width: 99%;">
			<tr>
		    	<td style="text-align: left; height: 50px;"  class="fordotmatrix">Certified By:</td>
		    	<td style="text-align: left; padding-left: 60px"  class="fordotmatrix">Noted By:</td>
		  	</tr>
		  	<tr>
    			<td style="padding-top: 20px">__________________________________</td>
    			<td style="padding-top: 20px; padding-left: 60px">__________________________________</td>
    		</tr>
		</table>
  	</td>
  </tr>
