...
<div style="margin: 0 auto; text-align: center"><strong>Notes and Collection Report</strong></div>

<table class="detail" style="margin: 0px; border: 0px;">

<tr>
<td class=""><strong>FOR THE DATE:</strong> <?php echo date('M d, Y', strtotime($yearmonth . "-" . $date_day)) . " to " . date('M d, Y', strtotime($yearmonth . "-" . $end_day)) ?></td>
<td style="font-weight: bold"></td>
</tr>

<tr>
<td class=""><strong>RUN DATE:</strong> <?php echo date('M d, Y')?></td>
<td style="font-weight: bold"></td>
</tr>

<tr>
<td class=""><strong>NUMBER OF CUSTOMERS:</strong> <?php echo count($data);?></td>
<td style="font-weight: bold"></td>
</tr>
...
<!--	GENERATE NCR -->
<table class="ncr_table"  style="width:100%; margin: 0px; padding: 0px; font-size: 10px; border: 1px;" >
<!-- <table class="table table-striped table-bordered" style="font-size: 10px;"> -->
                                    	...
                                    	<?php foreach ($data as $key => $fields):?>
                                    				...
                                    				<?php $i = $date_day;?>
                                    				<?php while($i <= $end_day):?>
                                    					<th><?php echo date('m/d', strtotime($yearmonth . "-" . $i))?></th>	
                                    					<?php $i++;?>
                                    				<?php endwhile;?>
                                    	...
                                    	<?php foreach ($data as $key => $fields):?>
                                    				...
                                    				<td class="left" style="font-size: 11px"><strong><?php echo $fields['name']?></strong></td>
                                    				<!-- <td>td</td> -->
                                    				<?php $i = $date_day;?>
                                    				<?php while($i <= $end_day):?>
                                              ...
                                              <?php 
                                    					...
                                    					<?php if(isset($fields['loan_payments'][$yearmonth . "-" . $i])):?>
                                    						...
                                    						?>
                                    						<td class="right"><?php echo number_format($fields['loan_payments'][$yearmonth . "-" . $i], 2) == '0.00' ? '-' : number_format($fields['loan_payments'][$yearmonth . "-" . $i], 2) ?></td>
                                    					<?php else:?>
                                    						<td class="right">-</td>
                                    					<?php endif;?>
                                    				...
                                    				<td class="right"><?php echo number_format($fields['current_cutoff_total_payments'], 2); $current_cutoff_total_payments += $fields['current_cutoff_total_payments']; ?></td>
                                    				<td class="right"><?php echo number_format($fields['due'], 2); $due+=$fields['due']>0?$fields['due']:0;?></td>
                                    				<td class="right"><?php echo number_format($fields['overdue'], 2); $overdue+=$fields['overdue']>0?$fields['overdue']:0;?></td>
                                    				<td class="right"><?php echo number_format($fields['collectible'], 2); $collectible+=$fields['collectible']>0?$fields['collectible']:0;?></td>
                                    				<td class="right"><?php echo number_format($fields['balance'], 2);$loan_balance+=$fields['balance'];?></td>
                                    				<td class="right" style="font-size:9px"><?php echo $fields['date_released']?></td>
                                    				<td class="right" style="font-size:9px"><?php echo $fields['maturity_date']?></td>
                                    				<td class="right"><?php echo number_format($fields['amortization'], 2); $amortization+=$fields['amortization'];?></td>
                                    				</tr>
                                        ...
                                        <tfoot>
                                        	<tr style="font-weight: bold;">
                                        		...
                                        		<?php foreach($days_payments_total as $key => $val):?>
                                        			<td class="right"><?php echo number_format($val, 2);?></td>
                                        		<?php endforeach;?>
                                        		<td class="right"><?php echo number_format($current_cutoff_total_payments, 2)?></td>
                                        		<td class="right"><?php echo number_format($due, 2)?></td>
                                        		<td class="right"><?php echo number_format($overdue, 2)?></td>
                                        		<td class="right"><?php echo number_format($collectible, 2)?></td>
                                        		<td class="right"><?php echo number_format($loan_balance, 2)?></td>
                                        		<td class="right">-</td>
                                        		<td class="right">-</td>
                                        		<td class="right"><?php echo number_format($amortization, 2)?></td>
                                        	</tr>
                                        </tfoot>
                                    </table>
