...
<div style="margin: 0 auto; text-align: center"><h3>SALES AND COLLECTION REPORT</h3></div>
<div style="margin: 0 auto; text-align: center; font-size: 12px;">For the period of: <?php echo $yearmonth . "-" . $date_day . " to " . $yearmonth . "-" . $end_day;?></div>
<br>
...
<tr>
<td class="label"><strong>COLLECTION PERFORMANCE</strong></td>
...
<td class="right">Overdue</td>
<td class="right">Payment Due + Overdue</td>
<td class="right">Advance</td>
<td class="right">Collection Performance</td>
</tr>
<?php $total_due = 0; $total_od = 0; $total_pdo = 0; $total_adv = 0; $total_cp = 0;?>
<?php foreach($collection_data as $val):?>
	<tr class="list_row">
		<td class="center"><?php echo $val['area_name']?></td>
		<td class="right"><?php echo number_format($val['due'], 2, '.', ','); $total_due+= $val['due']?></td>
		<td class="right"><?php echo number_format($val['overdue'], 2, '.', ','); $total_od+= $val['overdue']?></td>
		<td class="right"><?php echo number_format($val['pdo'], 2, '.', ','); $total_pdo+= $val['pdo']?></td>
		<td class="right"><?php echo number_format($val['advance'], 2, '.', ','); $total_adv+= $val['advance']?></td>
		<td class="right"><?php echo number_format($val['cp'], 2, '.', ','); $total_cp=($total_pdo/($total_due + $total_od>0?$total_due + $total_od:1))*100?>%</td>
	</tr>
		
<?php endforeach;?>
	<tr class="list_row">
		<td  class="center" style="text-align: right"><strong>TOTAL:</strong></td>
        <td class="right"><strong><?php echo number_format($total_due, 2)?></strong></td>
        <td class="right"><strong><?php echo number_format($total_od, 2)?></strong></td>
        <td class="right"><strong><?php echo number_format($total_pdo, 2)?></strong></td>
        <td class="right"><strong><?php echo number_format($total_adv, 2)?></strong></td>
	    <td class="right"><strong><?php echo number_format($total_cp, 2)?>%</strong></td>
    </tr>
...
<tr>
<td class="label"><strong>SALES PERFORMANCE</strong></td>
...
<tr class="head">
<td class="center">Area</td>
<td class="center">Age of Area</td>
<td class="right">Minimum Sales Target</td>
<td class="right">Actual Sales</td>
<td class="right">Sales Performance</td>
...
<?php foreach($sales_data as $val):?>
  <?php $val['mst'] = 600000; ?>
	<tr class="list_row">
		<td class="center"><?php echo $val['area_name']?></td>
		<td class="right"><?php echo $val['age_of_area']?></td>
		<td class="right"><?php echo number_format($val['mst'], 2, '.', ','); $total_mst+=$val['mst']?></td>
		<td class="right"><?php echo number_format($val['actual_sales'], 2, '.', ','); $total_as+=$val['actual_sales']?></td>
		<td class="right"><?php echo number_format($val['sp'], 2, '.', ','); $total_sp = $total_mst==0 ?  $total_sp : ($total_as/$total_mst)*100?>%</td>
	</tr>
<?php endforeach;?>
	<tr class="list_row">
        <td class="center" colspan="2" style="text-align: right"><strong>TOTAL:</strong></td>
        <td class="right"><strong><?php echo number_format($total_mst, 2)?></strong></td>
        <td class="right"><strong><?php echo number_format($total_as, 2)?></strong></td>
        <td class="right"><strong><?php echo number_format($total_sp, 2)?>%</strong></td>
   </tr>
</table>
<br>
<br>
...
<tr>
<td class="label"><strong>LIST OF CUSTOMERS</strong></td>
...
<table class="list" style="width: 99%;">
	<tr class="head">
        ...
        <td class="right">Date Released</td>
        <td class="center">Loan Type</td>
        <td class="center">Area</td>
    </tr>
    ...
    <tr class="list_row">
        ...
        <td class="right"><?php echo number_format($val['loan_amount'], 2); $la_total += $val['loan_amount']?></td>
        <td class="center"><?php echo $val['date_released']?></td>
        <td class="center"><?php echo $val['loan_type']?></td>
        <td class="center"><?php echo $val['area']?></td>
    </tr>
     <?php $i++; endforeach;?>
     <tr class="list_row">
     	<td class="right" colspan="2" style="text-align: right"><strong>TOTAL:</strong></td>
        <td class="right"><strong><?php echo number_format($la_total, 2)?></strong></td>
        <td class="center"></td>
        <td class="center"></td>
        <td class="center"></td>
     </tr>
