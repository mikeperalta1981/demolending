...
<div style="margin: 0 auto; text-align: center"><h3>STATEMENT OF ACCOUNT</h3></div>

<table class="detail" style="margin: 0px; border-top: none;">

<tr>
<td class="label"><span class='fordotmatrix'>Name:</span></td>
<td class="field"><span class='fordotmatrix'><?php echo $loan_details[0]['name']?></span></td>
<td class="label"><span class='fordotmatrix'>Loan Amount:</span></td>
<td class="field"><span class='fordotmatrix'>PHP <?php echo number_format($loan_details[0]['loan_amount'], 2, '.', ',')?></span></td>
<td class="label"><span class='fordotmatrix'>Date Released:</span></td>
<td class="field"><span class='fordotmatrix'><?php echo $loan_details[0]['date_released']?></span></td>
</tr>

<tr>
<td class="label"><span class='fordotmatrix'>Account #:</span></td>
<td class="field"><span class='fordotmatrix'><?php echo $loan_details[0]['account_no']?></span></td>
<td class="label"><span class='fordotmatrix'>Amortization:</span></td>
<td class="field"><span class='fordotmatrix'>PHP <?php echo number_format($loan_details[0]['amortization'], 2, '.', ',')?></span></td>
<td class="label"><span class='fordotmatrix'>Maturity Date:</span></td>
<td class="field"><span class='fordotmatrix'><?php echo $loan_details[0]['maturity_date']?></span></td>
</tr>

<tr>
<!-- <td class="label">Payment Status:</td>
<td class="field">Gari Lusi</td> -->
<td class="label"><span class='fordotmatrix'>Outstanding Balance:</span></td>
<td class="field"><span class='fordotmatrix'>PHP <?php echo number_format($outstanding_balance, 2, '.', ',')?></span></td>
<td class="label"><span class='fordotmatrix'>Transaction Date:</span></td>
<td class="field"><span class='fordotmatrix'><?php echo date('Y-m-d')?></span></td>
</tr>
</table>
<br>
<div style="margin: 0 auto; text-align: center"><span class='fordotmatrix'><strong>Payment Record</strong></span></div>
<table class="list" style="width: 99%;">

<tr class="head">
<!-- <td class="center" style="width: 15%">Item</td> -->
<td class="center" style="width: 50%; padding-left: 200px;"><span class='fordotmatrix'>Payment Date</span></td>
<!-- <td class="center" style="width: 10%">Quantity</td>
<td class="center" colspan="2" style="width: 15%">Unit Cost</td> -->
<td class="right" style="width: 50%; padding-right: 200px;"><span class='fordotmatrix'>Amount</span></td>
</tr>

<?php foreach($loan_payments as $val):?>
	<tr class="list_row list_row_soa">
		<td class="center list_row_soa" style="padding-left: 200px;"><span class='soa_data'><?php echo $val['payment_date']?></span></td>
		<td class="right list_row_soa" style="padding-right: 200px;"><span class='soa_data'><?php echo number_format($val['amount'], 2, '.', ',')?></span></td>
	</tr>
		
<?php endforeach;?>

<tr class="foot">
<td class="center" style="padding-left: 200px;"><span class='fordotmatrix'>
<strong>TOTAL PAYMENTS:</strong></span></td>
<td class="right" style="font-weight: bold; padding-right: 200px;"><span class='fordotmatrix'>PHP <?php echo number_format($total_payments, 2, '.', ',')?></span></td>
</tr>
...
<table class="signature_table">
  ...
  <tr>    
    <td><span class='soa_signature'>Prepared by:</span></td><td class="written_field" style="width: 38%">&nbsp;</td>
    <td style="padding-left: 1em"><span class='soa_signature'>Approved by:</span></td>
    <td class="written_field" style="width: 39%; text-align: right;"></td>
  </tr>
  <!-- 
  <tr>
