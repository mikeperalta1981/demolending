...
<br><br><br><br><br><br>
<table style="border: none; width: 90%; padding-left: 40px" align="center">

	<tr>
		<td class="label">PAID TO:</td>
		<td class="field"><?php echo $customer_name?></td>
	...
	<tr>
		...
		<td class="field"><?php echo $account_no?></td>
	</tr>
	<tr>
		<td></td>
		<td></td>
		<td class="label">CHEQUE #:</td>
		<td class="field"><?php echo $cheque_no?></td>
	</tr>

</table>
<br>
<table style="border: 2px solid black; width: 80%; padding: 20px" align="center">
	<tr>
		<td class="label">Loan Amount</td>
		<td style="width: 50%"></td>
		<td class="field_money">P <?php echo number_format($loan_amount, 2)?></td>
	</tr>
	<tr>
		<td class="label">Less</td>
		<td class="label">INTEREST @ <?php echo $interest_pct?>% FOR <?php echo $loan_term_duration?> DAYS</td>
		<td class="field_money"><?php echo $interest_amount?></td>
	</tr>
	<tr>
		<td class="label"></td>
		<td class="label">DOCUMENTARY STAMP AND NOTARIAL FEE</td>
		<td class="field_money"><?php echo number_format($service_fee, 2)?></td>
	</tr>
	<tr>
		<td class="label"></td>
		<td class="label">OTHERS</td>
		<td class="field_money"><?php echo $others?></td>
	</tr>
	<tr>
		<td class="label">NET PROCEEDS</td>
		<td></td>
		<td class="field_money">P <?php echo number_format($net_proceeds, 2)?></td>
	</tr>
</table>
...
<table style="border: none; width: 90%; padding-left: 40px" align="center">
  	<tr>
		<td>APPROVED BY:<br><br><br>____________________</td>
		<td>RECEIVED BY:<br><br><br><span style="font-weight: bold"><?php echo $customer_name?></span><br><span style="font-size: 10px;">Signature over printed name</span></td>
	</tr>
